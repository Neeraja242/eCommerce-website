  ...
  return (
    <form  onSubmit={onSubmitHandler} className='flex flex-col w-full items-start gap-3'> 
      ...
      <div className='w-full'>
        ...
        <textarea onChange={(e)=>setDescription(e.target.value)}  value={description} className='w-full max-w-125 px-3 py-2' type='text' placeholder='content' required />
      </div>
      ...
      <button type="submit" className='w-28 py-3 mt-4 bg-blue-900 text-white'>ADD</button>
    </form>
